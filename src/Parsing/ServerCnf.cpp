...
/*			Error Print 			*/
	...
	{
		std::cout << "Error In config File please Fixe it Thank u." << std::endl;
		_ifs.close();
		exit(0);
		return (1);
	}
...
/*			Print Instance 			*/
	void	ServerCnf::printInstance(void)
	{
		...
		{			
			...
			std::cout << "_srvs[" << serv << "]._error_pages = [" << "PATH" << "] = "<< _srvs[serv]._error_pages.second << std::endl;
			std::cout << "**********************************" << std::endl;
			...
			{			
				...
				std::cout << "**********************************" << std::endl;
				std::cout << "_srvs[" << serv << "]._locs[" << k << "]._redirection = Nmbr redi = [" << _srvs[serv]._locs[k].getRedirect().first << "]"<< " | Path [" << _srvs[serv]._locs[k].getRedirect().second << "]"  << std::endl;
				std::cout << "**********************************" << std::endl;
